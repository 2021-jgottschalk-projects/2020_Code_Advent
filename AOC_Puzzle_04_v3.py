...
for item in maybe_valid:
    ...
    if result is not None:
        ...
        if all_height[-1] == "m":
            height = all_height[4:7]
            height_points = check_int(height, 150, 193)
        else:
